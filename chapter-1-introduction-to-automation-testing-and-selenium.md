...
Automation testing is a software testing technique where testers use tools, scripts and frameworks to execute test cases on an application, instead of performing manually
